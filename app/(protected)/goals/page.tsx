...
export default async function GoalsPage() {
  ...
  return <main className={styles.page}>
    <header className={styles.header}><div><p className={styles.eyebrow}>{result.data.workspace.name}</p><h1>Metas financeiras</h1></div><nav className={styles.nav} aria-label="Navegação principal"><Link href="/dashboard">Dashboard</Link><Link href="/goals" aria-current="page">Metas</Link></nav></header>
